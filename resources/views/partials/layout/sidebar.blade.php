    ...
    <div id="kt_app_sidebar_wrapper" class="app-sidebar-wrapper">
        <div class="hover-scroll-y my-5 my-lg-2 mx-4" data-kt-scroll="true"
            ...
            <div id="kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ request()->is('config/*') ? 'show' : '' }}">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a href="{{ route('settings.users') }}" class="menu-link {{ request()->is('config/usuarios') ? 'active' : '' }}">
                                <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
                                <span class="menu-title">Usuarios</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a href="{{ route('settings.agent') }}" class="menu-link {{ request()->is('config/agente') ? 'active' : '' }}">
                                <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
